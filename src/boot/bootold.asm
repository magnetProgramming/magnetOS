...
; command output
help_text: db "Commands: help, clear, version, reboot", 0
version_text: db "magnetOS 0.1 (Real Mode)", 0
...
print:
	...
	.done:
		...
		ret
; getch
; waits for a key, returns ASCII in AL, echoes it
getch:
	xor ah, ah
	int 0x16
	ret
